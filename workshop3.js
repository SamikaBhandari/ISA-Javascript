...
//A function that returns the string "something" joined with a space " " and the given argument a.
function smth(a){
    return `something ${a}`;
}
...
//counting points for a basketball game, given the amount of 2-pointers scored and
